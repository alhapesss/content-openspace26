...
export function DriveLinkModal({ open, contentTitle, onClose, onSave }: DriveLinkModalProps) {
  ...
  return (
    ...
    >
      <div className="bg-[#262622] border border-[#4d4d47] rounded-md p-6 w-full max-w-[400px]">
        <h3 className="text-base font-extrabold uppercase tracking-wide mb-4 text-[#c1ff1a]">
          Link Konten/Design
        </h3>

        <div className="mb-4">
          <label className="block font-mono text-[11px] uppercase tracking-wider text-[#b8b8b0] mb-2">
            Konten
          </label>
          <p className="text-[13px] text-[#f2efe9] mb-4 p-2.5 bg-[#2e2e2a] border border-[#4d4d47] rounded-sm">
            {contentTitle}
          </p>
        </div>
        ...
        <div className="mb-4">
          ...
          <input
            ...
            className="w-full bg-[#2e2e2a] border border-[#4d4d47] text-[#f2efe9] px-2.5 py-2 rounded-sm text-[13px] focus:outline-none focus:border-[#b8b8b0] transition-colors"
          />
        ...
        {toast && (
          <div className="absolute bottom-4 left-1/2 -translate-x-1/2 bg-[#2e2e2a] border border-[#ff00ae] text-[#ff00ae] px-4 py-2 rounded-sm text-[13px] whitespace-nowrap">
            {toast}
          </div>
        )}
      </div>
